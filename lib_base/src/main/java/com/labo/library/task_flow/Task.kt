...
import com.labo.library.task_flow.TaskRuntime.executeTask
import com.labo.library.task_flow.TaskRuntime.removeBlockTask
import com.labo.library.task_flow.TaskRuntime.setStateInfo
import com.labo.library.task_flow.TaskRuntime.setThreadName
import com.labo.library.task_flow.TaskRuntime.sTaskComparator
import java.util.*
...
abstract class Task @JvmOverloads constructor(
    ...
    override fun compareTo(other: Task): Int {
        return TaskUtils.compareTask(this, other)
    }
