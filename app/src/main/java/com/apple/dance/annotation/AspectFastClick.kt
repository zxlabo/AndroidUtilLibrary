...
//    @com.apple.dance.annotation.AopOnclick：注解筛选，注意：这里@com.apple.dance.annotation 需要替换成 自己项目中AopOnclick这个类的全路径
//     *：类路径,*为任意路径
//     * 法名,*为任意方法名
//     * (..)：方法参数,'..'为任意个任意类型参数
//    &&：并集
//     */
//    @Pointcut("execution(@com.apple.dance.annotation.AopOnclick * *(..))")
//    fun methodAnnotated() {
//    }
//
//    /**
